...
```html
# 使用 curl 验证
curl -v https://i1.huanqiu-ltd.com/.env
...
# 使用浏览器直接访问
# 访问: https://i1.huanqiu-ltd.com/.env
```
...
**证据**:
```
缺失: X-Content-Type-Options, X-XSS-Protection
```
