...
**漏洞URL**: https://www.fenqile.com/robots.txt
...
```html
# 使用 curl 验证
curl -v https://www.fenqile.com/robots.txt

# 使用 Python 验证
import requests
resp = requests.get("https://www.fenqile.com/robots.txt")
print(resp.text)

# 使用浏览器直接访问
# 访问: https://www.fenqile.com/robots.txt
```
